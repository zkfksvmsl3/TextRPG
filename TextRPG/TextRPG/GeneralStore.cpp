...
{
	recoveryItemList.push_back(*item);
}
void GeneralStore::ItemPrint(int* iItemIndex)
{
...
void GeneralStore::ItemSale(Character *_character, bool * _isQuit)
{
	system("cls");
...
void GeneralStore::EnterStore(Character* _character)
{
	system("cls");
